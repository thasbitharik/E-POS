        ...
        <div class="col-12 col-md-12">
            <div class="card card-tpos-secondary2">
                <div class="table-top-area">
                    <h4 class="table-title">Measurements</h4>
                            ...
                            <table class="table table-bordered table-hover table-bg mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-d-blue">Measurement</th>
                                ...
                                <tr>
                                    <td>{{ $x }}.</td>
                                    <td class="text-capitalized">{{ $row->measurement }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    ...
                    {{-- Measurement --}}
                    <div class="form-group">
                        <label class="text-blue">Measurement <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_measurement"
                            placeholder="Measurement" wire:keydown.enter.prevent="saveData">
                        @if ($showError)
