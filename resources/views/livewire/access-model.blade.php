        ...
        <div class="col-12 col-md-12">
            <div class="card card-tpos-secondary2">
                <div class="table-top-area">
                    <h4 class="table-title">Access Models</h4>
                            ...
                            <table class="table table-bordered table-hover table-bg mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-d-blue">Access Model</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    {{-- Access model name --}}
                    <div class="form-group">
                        <label class="text-blue">Access Model <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_access_model"
