...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-blue border-b-blue">
            ...
            <li class="breadcrumb-item"><a href="/access-model"><i class="fas fa-user-plus"></i>Access Model</a></li>
            ...
            <div class="card card-tpos-secondary2">
                <div class="table-top-area">
                    <h4 class="table-title">
                        Access Points of <span class="text-blue">({{ $accessModelData->access_model }})</span>
                    </h4>
                            ...
                            <table class="table table-bordered table-hover table-bg mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-d-blue">Access Point</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    {{-- Access point --}}
                    <div class="form-group">
                        <label class="text-blue">Access Point <font color="red">*</font></label>
                        <select class="form-control custom-form-input1" wire:model="new_access_point">
