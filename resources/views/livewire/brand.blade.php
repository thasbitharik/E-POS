        ...
        <div class="col-12 col-md-12">
            <div class="card card-tpos-secondary2">
                <div class="table-top-area">
                    <h4 class="table-title">Brands</h4>
                    ...
                    <div class="sub-card">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-bg mb-0">
                                ...
                                <tr>
                                    <td>{{ $x }}.</td>
                                    <td class="text-capitalized">{{ $row->brand }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    ...
                    {{-- Brand name --}}
                    <div class="form-group">
                        <label class="text-blue">Brand <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_brand"
                            placeholder="Brand" wire:keydown.enter.prevent="saveData">
                        @if ($showError)
                        @error('new_brand')
