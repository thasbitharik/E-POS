...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-blue border-b-blue">
            ...
            <li class="breadcrumb-item"><a href="#"><i class="far fa-user"></i>Customers</a></li>
                            ...
                            <table class="table table-bordered table-hover table-bg mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-d-blue text-right">Credit</th>
                                ...
                                <tr>
                                    <td>{{ $x }}.</td>
                                    <td class="text-capitalized">{{ $row->shop_name }}</td>
                                    <td>{{ $row->tp }}</td>
                                    <td>{{ $row->code }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    ...
                    {{-- Shop name --}}
                    <div class="form-group">
                        <label class="text-blue">Shop Name <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" placeholder="Shop Name"
