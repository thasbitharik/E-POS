...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-blue border-b-blue">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Bank</li>
        </ol>
    </nav>
        ...
        <div class="col-12 col-md-8 offset-md-4">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button id="formOpen" wire:click="openModel" class="btn btn-tpos-primary ml-1">
                            ...
                            <table class="table table-bordered table-hover table-bg mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-d-blue">Bank</th>
                                        <th class="text-d-blue text-center">Account Number</th>
                                        <th class="text-d-blue text-right">Opening Balance</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="text-blue">Bank <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_bank"
                            placeholder="Bank">
                        @if ($showError)
                        @error('new_bank')
                    ...
                    <div class="form-group">
                        <label class="text-blue">Account Number <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_account_number"
                            placeholder="Account Number">
                        @if ($showError)
                        @error('new_account_number')
                        <span class="text-danger text-sm">{{ $message }}</span>
                        @enderror
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        <label class="text-blue">Opening Balance <font color="red">*</font></label>
                        <input type="number" class="form-control custom-form-input1" wire:model="new_opening_balance"
                            placeholder="Opening Balance">
                        @if ($showError)
                        @error('new_opening_balance')
                        <span class="text-danger text-sm">{{ $message }}</span>
                        @enderror
                        @endif
                    </div>
