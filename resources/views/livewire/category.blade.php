                    ...
                    <div class="sub-card">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-bg mb-0">
                                ...
                                <tr>
                                    <td>{{ $x }}.</td>
                                    <td class="text-capitalized">{{ $row->category }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    {{-- Category --}}
                    <div class="form-group">
                        <label class="text-blue">Category <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_category"
                            placeholder="Category" wire:keydown.enter.prevent="saveData">
                        @if ($showError)
                        @error('new_category')
