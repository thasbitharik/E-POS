...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-blue border-b-blue">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Income Type</li>
        </ol>
    </nav>
        ...
        <div class="col-12 col-md-12">
            <div class="card card-tpos-secondary2">
                <div class="table-top-area">
                    <h4 class="table-title">Income Type</h4>
                            ...
                            <table class="table table-bordered table-hover table-bg mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-d-blue text-cemter">Actions</th>
                                    </tr>
                                </thead>
                                @php($x = 1)
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content card-tpos-primary2">
                ...
                <div class="modal-body">
                    ...
                    {{-- Income type --}}
                    <div class="form-group">
                        <label class="text-blue">Income Type <font color="red">*</font></label>
                        <input type="text" class="form-control custom-form-input1" wire:model="new_income_type"
                            placeholder="Income Type" wire:keydown.enter.prevent="saveData">
                        @if ($showError)
